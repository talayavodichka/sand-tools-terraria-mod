...
namespace SandTools.Minions
{
    public class PoopyMonster : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<PoopyMonsterBuff>());
                return;
            }

            if (owner.HasBuff(ModContent.BuffType<PoopyMonsterBuff>()))
            {
